...
namespace Smartsheetsproject.Controllers
{
    public class DesignController : Controller
    {
        ...
        public IActionResult Edit(DesignModel model)
        {
            ...
            {
                DesignModel model_lists = GetListValues(model.pipelineId);
            ...
            foreach (var cell in row.Cells)
            {
                ...
                switch (columnName)
                {
                    ...
                    case "Status":
                        ...
                        //case "Story":
                        //    story_cell.ColumnId = columnid;
                        //    story_cell.Value = project.story;
                        //    break;
        ...
        public DesignModel GetListValues(long row_id)
        {
            DesignModel project = new DesignModel();
            project.pipelineId = row_id;
            Sheet sheet = LoadSheet(sheetId, initSheet());
